...
import { ProductDetailComponent } from '../app/products/pages/product-detail.component';
import { ConvertToSpacesPipe } from '../app/pipes/convert-to-spaces.pipe';
import { ProductDetailGuard } from '../app/products/components/product-detail.guard';
